...
const ProductDetails = () => {
  const [product] = useState({
    ...
    discount: 20,
    price: 80,
    description: "The languages only differ in their grammar, their pronunciation and their most common words. Everyone realizes why a new common language would be desirable: one could refuse to pay expensive translators.",
    rating: 4.5,
    features: ["Sed ut perspiciatis unde", "Itaque earum rerum hic", "Nemo enim ipsam voluptatem", "Donec quam felis ultricies nec", "Temporibus autem quibusdam et"]
  });
  const [discountPrice] = useState(Math.round(product.price - product.price * product.discount / 100));
  return <>
                  ...
                  <Tab.Container id="left-tabs-example" defaultActiveKey="product-1-item">
                    <Tab.Content className="p-0">
                      <Tab.Pane eventKey="product-1-item">
                        <img src={productImg1} alt="" className="img-fluid mx-auto d-block rounded" />
                      </Tab.Pane>
                      <Tab.Pane eventKey="product-2-item">
                        <img src={productImg2} alt="" className="img-fluid mx-auto d-block rounded" />
                      </Tab.Pane>
                      <Tab.Pane eventKey="product-3-item">
                        <img src={productImg3} alt="" className="img-fluid mx-auto d-block rounded" />
                      </Tab.Pane>
                      <Tab.Pane eventKey="product-4-item">
                        <img src={productImg4} alt="" className="img-fluid mx-auto d-block rounded" />
                      </Tab.Pane>
                    </Tab.Content>
