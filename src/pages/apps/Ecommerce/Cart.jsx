            ...
            <Card.Body>
              <Row>
                <Col lg={8}>
                  <div className="table-responsive">
                    <table className="table table-borderless table-centered mb-0">
                      ...
                      <tbody>
                        ...
                        return <tr key={idx}>
                              <td>
                                <img src={item.image} alt={item.name} title="contact-img" className="rounded me-3" height="48" />
                  ...
                  <Row className="mt-4">
                    <Col sm={6}>
                      <a href="/apps/ecommerce/products" className="btn text-muted d-none d-sm-inline-block btn-link fw-semibold">
