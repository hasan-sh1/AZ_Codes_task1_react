...
const Products = () => {
  ...
  return <React.Fragment>
              ...
              <Row className="justify-content-between">
                <Col className="col-auto">
                  <form className="d-flex flex-wrap align-items-center">
                    ...
                    <div className="me-3">
                      <input type="search" className="form-control my-1 my-lg-0" id="inputPassword2" placeholder="Search..." onChange={e => searchProduct(e.target.value)} />
                    </div>
      ...
      <Row>
        ...
        return <Col key={index} md={6} xl={3}>
