          ...
          <Row>
            <Col md={6}>
              ...
              <div className="d-flex align-items-start">
                <img src={ticketDetails.reported_by.image} alt="" className="rounded-circle me-2" height="24" />
                <div className="w-100">
            ...
            <Col md={6}>
              ...
              <div className="d-flex align-items-start">
                <img src={ticketDetails.assigned_to.image} alt="" className="rounded-circle me-2" height="24" />
                <div className="w-100">
