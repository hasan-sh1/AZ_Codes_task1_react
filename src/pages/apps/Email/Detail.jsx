          ...
          <Card>
            <Card.Body>
              <div className="inbox-leftbar">
                <Link to="/apps/email/compose" className="btn btn-danger w-100 waves-effect waves-light">
                  Compose
                </Link>
              ...
              <div className="inbox-rightbar">
                ...
                <div className="mt-4">
                  ...
                  <div className="d-flex align-items-start mb-3 mt-1">
                    <img className="d-flex me-2 rounded-circle" src={email.avatar} alt={email.from_name} height="32" />
                    <div className="w-100">
