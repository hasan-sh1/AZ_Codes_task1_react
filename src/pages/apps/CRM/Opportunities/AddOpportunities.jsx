      ...
      <Modal show={show} onHide={onHide} aria-labelledby="contained-modal-title-vcenter" centered>
        ...
        <Modal.Body className="p-4">
          <VerticalForm onSubmit={onSubmit} resolver={schemaResolver}>
            <FormInput label="Company Name" type="text" name="name" placeholder="Enter company name" containerClass={"mb-3"} />
            ...
            <FormInput label="Category" type="text" name="category" placeholder="Enter category" containerClass={"mb-3"} />
