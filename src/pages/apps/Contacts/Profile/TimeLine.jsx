...
const FormPost = () => {
  return <form action="#" className="comment-area-box mt-2 mb-3">
...
const PostComment = ({
  ...
  return <div className="d-flex align-items-start">
      ...
      <div className="w-100">
        ...
        {comment.replies ? <Link to="#" className="text-muted font-13 d-inline-block mt-2 mb-3">
...
const Post = ({
  ...
  return <div className="border border-light p-2 mb-3">
      ...
      {post.comments ? <div className="post-user-comment-box">
      ...
      {post.engagement ? <div className="mt-2">
          {post.comments ? null : <Link to="#" className="btn btn-sm btn-link text-muted">
              <i className="mdi mdi-reply"></i> Reply
            </Link>}
          {post.isLiked ? <Link to="#" className="btn btn-sm btn-link text-danger">
              <i className={classnames("mdi", "mdi-heart")}></i> Likes (
              {post.totalLikes})
            </Link> : <Link to="#" className="btn btn-sm btn-link text-muted">
