          ...
          <Row>
            <Col>
              ...
              width: "100%"
                ...
                {(user || []).map((user, index) => {
                return <Link to="#" key={index} className="text-body" onClick={e => {
                  activateUser(user);
                }}>
                      <div className={classnames("d-flex", "align-items-start", "p-2", {
                    "bg-light": user.id === selectedUser.id
                  })}>
                        <img src={user.avatar} className="me-2 rounded-circle" height="42" alt="" />
                        ...
                        <div className="w-100">
                          ...
                          <p className="mt-1 mb-0 text-muted font-14">
                            <span className="w-25 float-end text-end">
                              {user.totalUnread !== 0 && <span className="badge badge-soft-danger">
                                  {user.totalUnread}
                                </span>}
                            </span>
