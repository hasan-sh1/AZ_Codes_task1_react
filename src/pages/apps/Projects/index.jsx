...
const SingleProject = props => {
  ...
  return <Card className="project-box">
      <Card.Body>
        ...
        <div className="avatar-group mb-3">
          ...
          return <OverlayTrigger key={index} placement="bottom" overlay={<Tooltip id={member.name}>{member.name}</Tooltip>}>
        ...
        <ProgressBar now={project.progress} className="mb-1" style={{
        height: "7px"
      }} />
      </Card.Body>
    </Card>;
...
const Projects = () => {
  return <>
      ...
      <Row>
        ...
        return <Col lg={4} key={"proj-" + project.id}>
