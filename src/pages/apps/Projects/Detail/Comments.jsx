      ...
      <Card.Body>
        ...
        <div className="mt-2">
          <div className="d-flex align-items-start">
            <img className="me-2 avatar-sm rounded-circle" src={avatar3} alt="" />
            <div className="w-100">
              <h5 className="mt-0">
          ...
          <div className="d-flex align-items-start mt-3">
            <img className="me-2 avatar-sm rounded-circle" src={avatar2} alt="" />
            <div className="w-100">
              <h5 className="mt-0">
                <Link to="/apps/contacts/profile" className="text-reset">
                  Jonathan Tiner
          ...
          <div className="d-flex align-items-start mt-3">
            <Link to="#" className="pe-2">
              <img src={avatar1} className="rounded-circle" alt="ge" height="31" />
            </Link>
            <div className="w-100">
              <input type="text" id="simpleinput" className="form-control form-control-sm form-control-light" placeholder="Add comment" />
            </div>
          </div>
        </div>
