          ...
          <Card>
            <Card.Body>
              <form onSubmit={handleSubmit(() => {})}>
                <Row>
                  <Col xl={6}>
                    <FormInput name="name" label="Project Name" placeholder="Enter project name" containerClass={"mb-3"} register={register} key="name" errors={errors} control={control} />

                    <FormInput name="overview" label="Project Overview" placeholder="Enter some brief about project.." type="textarea" rows="5" containerClass={"mb-3"} register={register} key="overview" errors={errors} control={control} />
                    ...
                    <div className="mb-3">
                      ...
                      <div className="form-check form-check-inline">
                        <input type="radio" id="customRadio3" name="customRadio" className="form-check-input" defaultChecked />
                    ...
                    <Row>
                      <Col lg={6}>
                        <Form.Group className="mb-3">
                          ...
                          <HyperDatepicker hideAddon value={startDate.toDateString()} onChange={date => setStartDate(date)} />
                        </Form.Group>
                      </Col>
                      <Col lg={6}>
                        <Form.Group className="mb-3">
                          <Form.Label>Due Date</Form.Label>
                          <HyperDatepicker hideAddon value={endDate.toDateString()} onChange={date => setEndDate(date)} />
                        </Form.Group>
                      </Col>
                    </Row>
                    ...
                    <Form.Group className="mb-3 mt-3 mt-xl-0">
                      ...
                      <Typeahead id="select3" multiple={false} options={[{
                      id: 1,
                      value: "MD",
                      label: "Medium"
                    }, {
                    ...
                    <FormInput name="budget" label="Budget" placeholder="Enter project budget" type="number" containerClass={"mb-3"} register={register} key="budget" errors={errors} control={control} />
                  </Col>
                  <Col xl={6}>
                    <Form.Group className="my-3 mt-xl-0">
                      ...
                      <DropzoneFormInput className="py-2" text="Drop your images here, or click to browse" helpText={<span className="text-muted fs-13 ">(1600 x 1200 (4:3) recommended. PNG, JPG and GIF files are allowed )</span>} showPreview />
                    </Form.Group>

                    <Form.Group className="mb-3">
                      <Form.Label>Team Members</Form.Label>
                      <Typeahead id="select3" labelKey="name" multiple={false} options={teamMembers} placeholder="select Team Member..." onChange={selectTeamMembers} />
                      <div className="mt-2">
                        {(selectedTeamMembers || []).map((member, index) => {
                        return <OverlayTrigger key={index} placement="top" overlay={<Tooltip id={member.name}>
                                  {member.name}
                                </Tooltip>}>
                              <a href="/" title={member.name} data-original-title="James Anderson" className="d-inline-block me-1">
