                ...
                <Row>
                    <Col lg={6}>
                        <div className="mb-3">
                            ...
                            <HyperDatepicker hideAddon={true} value={selectedDate} onChange={date => {
              onDateChange(date);
            }} />
                        </div>
                    </Col>
                    <Col lg={6}>
                        <div className="mb-3">
                            ...
                            <br />
                            <HyperDatepicker hideAddon={true} monthsShown={2} value={selectedDate} onChange={date => {
              onDateChange(date);
            }} />
                        </div>
                    </Col>
                ...
                <Row>
                    <Col lg={6}>
                        <div className="mb-3">
                            ...
                            <HyperDatepicker hideAddon={true} dateFormat="yyyy-MM-dd" value={selectedDate} onChange={date => {
              onDateChange(date);
            }} />
                        </div>
                    </Col>
                    <Col lg={6}>
                        <div className="mb-3">
                            ...
                            <HyperDatepicker hideAddon={true} minDate={new Date()} maxDate={new Date(new Date().setDate(new Date().getDate() + 7))} value={selectedDate} onChange={date => {
              onDateChange(date);
            }} />
                        </div>
                    </Col>
                ...
                <Row>
                    <Col lg={6}>
                        <div className="mb-3">
                            ...
                            <HyperDatepicker hideAddon={true} showTimeSelect timeFormat="HH:mm" tI={60} dateFormat="MMMM d, yyyy h:mm aa" timeCaption="time" value={selectedDate} onChange={date => {
              onDateChange(date);
            }} />
                        </div>
                    </Col>
                    <Col lg={6}>
                        <div className="mb-3">
                            ...
                            <HyperDatepicker hideAddon={true} showTimeSelect showTimeSelectOnly tI={60} dateFormat="h:mm aa" timeCaption="Time" value={selectedDate} onChange={date => {
              onDateChange(date);
            }} />
                        </div>
                    </Col>
                ...
                <Row>
                    ...
                    <Col lg={6}>
                        <div className="mb-3">
                            ...
                            <MaskedInput mask={'(00) 000-0000'} placeholder="(___) ___-____" className="form-control" />
                        </div>
                    </Col>
                </Row>
