          ...
          <Row>
            <Col lg={6}>
              <form onSubmit={handleSubmit(() => {})}>
                ...
                <FormInput label="Show/Hide Password" type="password" name="password" placeholder="password placeholder" containerClass={"mb-3"} register={register} key="password" errors={errors} control={control} />
...
const CheckboxBasic = () => {
  ...
  return <>
      ...
      return <Form.Check key={index} label={item.name} type="checkbox" id={`basic-checkbox-${index}`} className={classNames("mb-2", "form-check-" + item.variant)} aria-label="option 1" defaultChecked={index % 2 === 0} />;
    })}
    </>;
};
const CheckboxCircled = () => {
  ...
  return <>
      ...
      {(colors || []).map((item, index) => {
      return <Form.Check key={index} id={`circle-checkbox-${index}`} className={classNames("mb-2", "form-check", "form-check-" + item.variant)}>
...
const CheckboxDisabled = () => {
  ...
  return <>
      ...
      {(colors || []).map((item, index) => {
      return <Form.Check key={index} label={item.name} id={`circled-radio-${index}`} type="radio" className={classNames("mb-2", "form-check-" + item.variant)} aria-label="option 1" disabled defaultChecked={index % 3 === 0} />;
    })}
    </>;
};
const RadioBasic = () => {
  ...
  return <>
      ...
      <Row>
        <Col sm={6}>
          {(colors || []).map((item, index) => {
          return <Form.Check key={index} type="radio" id={`basic-radio-${index}`} label={item.name} className={classNames("mb-2", "form-check-" + item.variant)} aria-label="option 1" name="customradio1" defaultChecked={index === 2} />;
        })}
        </Col>
        <Col sm={6}>
          {(colors || []).map((item, index) => {
          return <Form.Check key={index} type="radio" id={`basic-radio2-${index}`} label={item.name} className={classNames("mb-2", "form-check-" + item.variant)} aria-label="option 1" defaultChecked={index % 3 === 0} />;
        })}
        </Col>
      </Row>
    </>;
...
const RadioDisabled = () => {
  ...
  return <>
      ...
      {(colors || []).map((item, index) => {
      return <Form.Check id={"custom-checkbox-" + item.variant} type="radio" key={index} label={item.name} className={classNames("mb-2", "form-check-" + item.variant)} aria-label="option 1" disabled defaultChecked />;
    })}
    </>;
};
const BasicForms = () => {
