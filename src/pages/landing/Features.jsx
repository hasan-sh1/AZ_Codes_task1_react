  ...
  return <>
      <section className="section">
        <div className="container-fluid">
          ...
          return feature.id % 2 !== 0 ? <Row key={index} className="align-items-center">
                <Col lg={6}>
                  <img src={feature.image} className="img-fluid mx-auto d-block" alt="" />
                </Col>
                <Col lg={6}>
                  <div className="p-5 features-content">
                    <div className="features-icon mb-4">
                      <i className={classNames(feature.icon, "h4", "text-white", "text-center")}></i>
                    </div>
              ...
              </Row> : <Row key={index} className="mt-5 align-items-center">
                <Col lg={6}>
                  <div className="p-5 features-content">
                    <div className="features-icon mb-4">
                      <i className={classNames(feature.icon, "h4", "text-white", "text-center")}></i>
