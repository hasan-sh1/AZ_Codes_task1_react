            ...
            <Col lg={10}>
              <div className="custom-form p-5 bg-white">
                ...
                <form onSubmit={handleSubmit(() => {})}>
                  <Row>
                    <Col lg={6}>
                      <FormInput type="text" label="Name" name="fullname" placeholder="Enter your name..." containerClass={"mb-3"} register={register} key="fullname" errors={errors} control={control} />
                    </Col>
                    <Col lg={6}>
                      <FormInput type="email" label="Email address" name="emailaddress" placeholder="Enter your email..." containerClass={"mb-3"} register={register} key="emailaddress" errors={errors} control={control} />
                    </Col>
                  </Row>
                  <Row className="mt-1">
                    <Col lg={12}>
                      <FormInput type="text" label="Subject" name="subject" placeholder="Enter subject..." containerClass={"mb-3"} register={register} key="subject" errors={errors} control={control} />
                    </Col>
                  </Row>
                  <Row className="mt-1">
                    <Col lg={12}>
                      <FormInput type="textarea" label="Message" name="comments" placeholder="Enter your message..." containerClass={"mb-3"} rows="4" register={register} key="comments" errors={errors} control={control} />
                    </Col>
                  </Row>
                  <Row>
