            ...
            <Card.Body>
              ...
              <div className="text-center">
                <div id="animationSandbox">
                  <img src={macbook} alt="" className="img-fluid center-block" />
                </div>
              </div>
                ...
                <div className="row justify-content-center">
                  <div className="col-sm-8">
                    <div className="input-group">
                      <select id="js--animations" className="form-select js--animations" onChange={e => triggerAnimation(e.target.value)}>
                      ...
                      <button className="btn input-group-text btn-primary waves-light waves-effect js--triggerAnimation" type="button" onClick={() => triggerAnimation(animationType)}>
                        Animate Me !
                      </button>
                    </div>
                  </div>
