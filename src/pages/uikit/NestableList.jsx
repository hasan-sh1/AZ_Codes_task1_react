      ...
      <Row>
        <Col lg={12}>
          <div className="text-start">
            <button type="button" className="btn btn-blue btn-sm waves-effect mb-3 waves-light me-1" onClick={() => setIsCollapsed(!isCollapsed)}>
            ...
            <Card.Body>
              <Row>
                <Col md={6}>
                  ...
                  <Nestable items={items} renderItem={RenderItem} className="custom-dd dd font-13" collapsed={isCollapsed} />
                </Col>
                <Col md={6}>
