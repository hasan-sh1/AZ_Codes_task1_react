...
const MovableCard = ({
  ...
  return <Card className={classNames("mb-0", "mt-3", "border", {
    "border-success": item.announced_on === "Latest"
  })}>
      <Card.Body>
        <span className={classNames("badge", "float-end", item.announced_on === "Latest" ? "badge-soft-success" : "badge-soft-secondary")}>
          {item.announced_on}
        </span>
        <h5 className="mt-0">
          <a href="/" className={classNames(item.announced_on === "Latest" ? "text-success" : "text-secondary")}>
            {item.title}
          </a>
        </h5>
        ...
        <div className="row">
          <div className="col">
            <Link to="#" className="text-reset">
              <img src={item.user.profile} alt="task-user" className="avatar-sm img-thumbnail rounded-circle" />
