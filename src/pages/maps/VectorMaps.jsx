        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <RussiaVectorMap height="300px" width="100%" options={{
              zoomOnScroll: false,
              regionStyle: {
                initial: {
                  fill: "#727cf5"
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <SpainVectorMap height="300px" width="100%" options={{
              zoomOnScroll: false,
              backgroundColor: "transparent",
              regionStyle: {
                initial: {
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <CanadaVectorMap height="300px" width="100%" options={{
              zoomOnScroll: false,
              backgroundColor: "transparent",
              regionStyle: {
                initial: {
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <UsaVectorMap height="300px" width="100%" options={{
              zoomOnScroll: false,
              backgroundColor: "transparent",
              regionStyle: {
                initial: {
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <ItalyVectorMap height="300px" width="100%" options={{
              zoomOnScroll: false,
              backgroundColor: "transparent",
              regionStyle: {
                initial: {
        ...
        <Col xl={6}>
          <Card>
            <Card.Body>
              ...
              <IraqVectorMap height="300px" width="100%" options={{
              zoomOnScroll: false,
              backgroundColor: "transparent",
              regionStyle: {
                initial: {
