          ...
          <Card>
            <Card.Body>
              ...
              <Row className="icons-list-demo">
                ...
                return icon.category === "new-icons" && <Col key={index} sm={6} md={4} lg={3}>
              ...
              <Row className="icons-list-demo">
                {(WEATHERICONS || []).map((icon, index) => {
                return icon.category === "day-time" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames("wi", "wi-" + icon.name)}></i>{" "}
                        <span> wi wi-{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(WEATHERICONS || []).map((icon, index) => {
                return icon.category === "night-time" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames("wi", "wi-" + icon.name)}></i>{" "}
                        <span> wi wi-{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(WEATHERICONS || []).map((icon, index) => {
                return icon.category === "neutral" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames("wi", "wi-" + icon.name)}></i>{" "}
                        <span> wi wi-{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(WEATHERICONS || []).map((icon, index) => {
                return icon.category === "miscellaneous" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames("wi", "wi-" + icon.name)}></i>{" "}
                        <span> wi wi-{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(WEATHERICONS || []).map((icon, index) => {
                return icon.category === "moon-phase" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames("wi", "wi-" + icon.name)}></i>{" "}
                        <span> wi wi-{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(WEATHERICONS || []).map((icon, index) => {
                return icon.category === "time" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames("wi", "wi-" + icon.name)}></i>{" "}
                        <span> wi wi-{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(WEATHERICONS || []).map((icon, index) => {
                return icon.category === "direction-arrows" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames("wi", "wi-" + icon.name)}></i>{" "}
                        <span> wi wi-{icon.name}</span>
                      </Col>;
              })}
