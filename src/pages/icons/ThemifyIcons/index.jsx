          ...
          <Card>
            <Card.Body>
              ...
              <Row className="icons-list-demo">
                ...
                return icon.category === "arrows-direction" && <Col key={index} sm={6} md={4} lg={3}>
              ...
              <Row className="icons-list-demo">
                {(THEMIFYICONS_LIST || []).map((icon, index) => {
                return icon.category === "web-app" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames(icon.name)}></i>{" "}
                        <span>{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(THEMIFYICONS_LIST || []).map((icon, index) => {
                return icon.category === "control" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames(icon.name)}></i>{" "}
                        <span>{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(THEMIFYICONS_LIST || []).map((icon, index) => {
                return icon.category === "text-editor" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames(icon.name)}></i>{" "}
                        <span>{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(THEMIFYICONS_LIST || []).map((icon, index) => {
                return icon.category === "layout" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames(icon.name)}></i>{" "}
                        <span>{icon.name}</span>
                      </Col>;
              })}
              ...
              <Row className="icons-list-demo">
                {(THEMIFYICONS_LIST || []).map((icon, index) => {
                return icon.category === "brand" && <Col key={index} sm={6} md={4} lg={3}>
                        <i className={classNames(icon.name)}></i>{" "}
                        <span>{icon.name}</span>
                      </Col>;
              })}
