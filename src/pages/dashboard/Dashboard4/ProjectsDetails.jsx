            ...
            <tbody>
              ...
              return <tr key={i}>
                    ...
                    <td>
                      ...
                      return <OverlayTrigger key={index} placement="top" overlay={<Tooltip id={item.name}>{item.name}</Tooltip>}>
                    ...
                    <td>
                      <span className={classNames("badge bg-soft-info text-info p-1", {
