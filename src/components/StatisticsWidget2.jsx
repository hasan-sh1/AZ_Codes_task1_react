      ...
      <Card>
        <Card.Body>
          ...
          <div className="mt-3">
            ...
            <ProgressBar now={props["progress"]} className="progress-sm m-0" label={`${props["progress"]}% Complete`} visuallyHidden variant={props["variant"]} />
          </div>
        </Card.Body>
      </Card>
    </>;
