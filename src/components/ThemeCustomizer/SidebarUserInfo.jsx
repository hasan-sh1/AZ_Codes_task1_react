...
const SidebarUserInfo = ({
  ...
  return <>
      ...
      <Form.Check className="form-check form-switch mb-1">
        <Form.Check.Input type="checkbox" name="leftsidebar-user" id="sidebaruser-check" onChange={e => toggleLeftSidebarUserInfo(e.target.checked)} checked={showSidebarUserInfo} />
